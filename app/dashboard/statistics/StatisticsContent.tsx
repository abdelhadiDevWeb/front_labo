...
export default function StatisticsPage() {
  ...
  const loadStatistics = async () => {
    ...
    try {
      ...
      const limited =
        basicResult.data?.isLimited === true ||
        detailedResult.data?.isLimited === true;
  ...
  const isLimited =
    basicStats?.isLimited === true || detailedStats?.isLimited === true;
        ...
        if (isLimited) {
          return [
            ...
            },
            {
              ...
              trend: (ordersGrowth >= 0 ? "up" : "down") as "up" | "down",
              icon: ShoppingCart,
              color: "bg-purple-500",
            },
            {
        ...
        return [
          {
            ...
            trend: (revenueGrowth >= 0 ? "up" : "down") as "up" | "down",
            icon: DollarSign,
            color: "bg-green-500",
          },
          {
    ...
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
          {isLimited ? "Statistiques d'activité" : "Statistiques Complètes"}
        </h2>
        <p className="text-gray-500 mt-1">
          {isLimited
            ? "Volumes et répartition — sans données financières ni contacts"
