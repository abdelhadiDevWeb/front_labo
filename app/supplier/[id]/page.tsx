          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 p-8">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1 text-white">
                ...
                <p className="text-blue-100 mb-4">Fournisseur certifié</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-8">
          ...
          <div className="p-6 space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-yellow-600 text-white rounded-lg font-semibold hover:bg-yellow-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {isSubmittingRating ? (
                      <>
            ...
            {isLoadingRatings ? (
              ...
              <div className="border-t border-gray-200 pt-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">Tous les avis</h4>
